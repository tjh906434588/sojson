...
// 网页常用色彩数据（由 linshi.txt 解析生成，勿手改）
export const colorGroups: ColorGroup[] = [
  {
    ...
    categories: [
      {
        title: "红色",
        desc: "是一种激奋的色彩。刺激效果，能使人产生冲动，愤怒，热情，活力的感觉",
      ...
      {
        title: "橙色",
        desc: "也是一种激奋的色彩，具有轻快，欢欣，热烈，温馨，时尚的效果",
      ...
      {
        title: "绿色",
        desc: "介于冷暖两中色彩的中间，显得和睦，宁静，健康，安全的感觉。它和金黄，淡白搭配，可以产生优雅，舒适的气氛",
      ...
      {
        title: "蓝色",
        desc: "是最具凉爽，清新，专业的色彩。它和白色混合，能体现柔顺，淡雅，浪漫的气氛(象天空的色彩:)白色---具有洁白，明快，纯真，清洁的感受",
