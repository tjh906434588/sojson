    ...
    <el-card class="tool-card">
      <template #header>
        <div class="tool-header">
          <h1 class="tool-title">{{ $t('tools.jsHtmlFormat.title') }}</h1>
          <p class="tool-description">{{ $t('tools.jsHtmlFormat.description') }}</p>
        </div>
      </template>
      ...
      <el-input
        ...
        type="textarea"
        :rows="10"
        placeholder="Enter JS or HTML code"
      />
...
const format = () => {
  ...
  try {
    ...
    ElMessage.error('Format failed: ' + e.message)
  }
}
